...
def _policy_kernel(x_ptr, w1_ptr, b1_ptr, w2_ptr, b2_ptr, w3_ptr, b3_ptr,
    ...
    # layer1: h1[j] = sum_k W1[j,k]*x[k] + b1[j], W1 shape [H, DIN]
    ...
    # layer2: h2[j] = sum_k W2[j,k]*h1[k] + b2[j], W2 shape [H, H]
    ...
    # layer3: out[j] = sum_k W3[j,k]*h2[k] + b3[j], W3 shape [DOUT, H]
