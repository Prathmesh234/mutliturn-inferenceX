...
def _focal_strided(x_ptr, t_ptr, out_ptr, n,
                   ...
                   d3: tl.constexpr, d4: tl.constexpr, d5: tl.constexpr,
                   d6: tl.constexpr, d7: tl.constexpr,
                   x0: tl.constexpr, x1: tl.constexpr, x2: tl.constexpr,
                   x3: tl.constexpr, x4: tl.constexpr, x5: tl.constexpr,
                   x6: tl.constexpr, x7: tl.constexpr,
                   y0: tl.constexpr, y1: tl.constexpr, y2: tl.constexpr,
                   y3: tl.constexpr, y4: tl.constexpr, y5: tl.constexpr,
                   y6: tl.constexpr, y7: tl.constexpr,
