...
def fused_block_kernel(pa, pb, pc, w1, b1, w2, b2, o_ptr, H, W, SLOPE,
    ...
    mask_w = ow < W
    HW = H * W
    for co in tl.static_range(COUT):
        ...
        for kh in tl.static_range(3):
            ...
            for kw in tl.static_range(3):
                ...
                roff = ih * W + iw
                # compute conv1 (1x1) intermediate channels at (ih, iw)
